        ...
        <table class="table table-borderless datatable">
          <thead>
            <tr>
              ...
              <th class="text-center">Số tối đa</th>
          ...
          <tbody>
            ...
            <c:forEach var="item" items="${classes}">
              ...
              <tr>
                ...
                <td class="text-center">${item.cohortID}</td>
                <td class="text-center">${item.maxStudents}</td>
                <td class="text-center">${item.currentStudents}</td>
                ...
                <td class="text-center">
                  <form action="${pageContext.request.contextPath}/admin/class" method="post">
                    ...
                    <input type="checkbox" name="isActive" ${item.active ? "checked" : ""} onchange="this.form.submit()" />
                  </form>
                </td>
                <td class="text-center">
                  <a href="${pageContext.request.contextPath}/admin/class?action=edit&id=${item.classID}" class="btn btn-primary btn-sm">
                    <i class="bi bi-pencil"></i>
                  </a>
                  <a href="${pageContext.request.contextPath}/admin/class?action=delete&id=${item.classID}" class="btn btn-danger btn-sm"
