    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            <li class="sidebar-item">
                <a href="${pageContext.request.contextPath}/teacher/home" class="sidebar-link">
            ...
            <li class="sidebar-item">
                <a href="${pageContext.request.contextPath}/teacher/profile.jsp" class="sidebar-link">
            ...
            <li class="sidebar-item">
                <a href="${pageContext.request.contextPath}/teacher/scores" class="sidebar-link">
            ...
            <li class="sidebar-item">
                <a href="${pageContext.request.contextPath}/teacher/achievements" class="sidebar-link">
        ...
        <div class="sidebar-footer mt-auto p-3">
            <div class="text-white-50 small">Phiên bản 1.0</div>
        </div>
    </aside>
