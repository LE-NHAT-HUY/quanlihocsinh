    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body p-4 p-lg-5">
            <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap mb-3">
                ...
                <a href="${pageContext.request.contextPath}/teacher/notifications" class="btn btn-outline-primary">
            ...
            <div class="mt-4 text-muted small">
                ...
                <c:if test="${notification.targetType == 'CLASS'}">
                    <span class="mx-2">|</span>
                    <i class="bi bi-building me-1"></i>Lớp ${notification.targetClassName != null ? notification.targetClassName : notification.targetClassID}
                </c:if>
            </div>
        </div>
    </div>
                                ...
                                <c:forEach var="file" items="${attachments}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-outline-primary" href="${pageContext.request.contextPath}/teacher/notifications/download?attachmentId=${file.attachmentID}">
