        ...
        <div class="card-body p-4 p-lg-5">
            <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                <div>
                    ...
                    <p class="text-muted mb-0">Các thông báo dành riêng cho lớp của bạn và toàn trường.</p>
                </div>
                <form class="d-flex gap-2" method="get" action="${pageContext.request.contextPath}/student/notifications">
        ...
        <c:when test="${empty notifications}">
            <div class="card shadow-sm border-0">
                <div class="card-body py-5 text-center text-muted">
                    ...
                    <p class="mb-0">Khi nhà trường hoặc giáo viên gửi thông báo, nội dung sẽ xuất hiện ở đây.</p>
                </div>
            </div>
        </c:when>
        <c:otherwise>
                            ...
                            <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                                <div class="flex-grow-1">
                                    <div class="d-flex align-items-center gap-2 mb-2 flex-wrap">
                                        ...
                                        <a href="${pageContext.request.contextPath}/student/notifications/detail?id=${item.notificationID}" class="text-primary fw-bold text-decoration-none fs-5">
                                            ${item.title}
                                        </a>
                                    </div>
