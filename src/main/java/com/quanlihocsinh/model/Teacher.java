...
public class Teacher {
    ...
    public String getGroupDV() {
        return groupDV;
    }

    public void setGroupDV(String groupDV) {
        this.groupDV = groupDV;
    }
    ...
    public void setNumberBHXH(String numberBHXH) {
        this.numberBHXH = numberBHXH;
    }
